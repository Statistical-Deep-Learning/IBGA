...
import  numpy as np
from    data import load_data, preprocess_features, preprocess_adj, load_data_all, load_data_all_for_gat
...
if __name__ == '__main__':
    ...
    for seed in range(0, 20):
        ...
        features = sparse_tuple_to_dense(features).float()
        adj =sparse_tuple_to_dense(adj)
